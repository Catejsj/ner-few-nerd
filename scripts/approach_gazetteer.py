...
def main() -> None:
    ...
    say("    that happen to be song titles ('It', 'Yesterday'), and they then match")
    ...
    if micro["precision"] < micro["recall"]:
        ...
        say("    and books. Once 'It' is in the list as an art entity it matches")
        say("    every occurrence of the pronoun.")
